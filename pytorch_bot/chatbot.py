...
# 
# 转换成ASCII，把所有字母转换成小写字母把所有非字母字符转换为基础符号，
# 把超长句子过滤
# 
# 
...
# the model must learn to approximate.删除很少使用的单词来加速收敛 We will do this as a two-step
# process:
# 
...
# First, we must define how we want the model to decode the encoded input.评估
# 
# Greedy decoding
# ~~~~~~~~~~~~~~~
# 
...
# iterations.
# 
# 跑模型，设置参数，初始化，然后调用TrainIters来跑模型
# 
# 
